import torch
from Engine import InferenceEngine, capture_graph
...
graph_run = capture_graph(engine=engine, decoding_seqlen=DEC_LENGTH)
...
logits = graph_run(input_ids=input_ids, storage_ids=storage_ids, position_ids=position_ids, attn_mask=attn_mask)
print(logits)
exit(0)
...
logits = graph_run(input_ids=extra_input_ids, storage_ids=extra_storage_ids, position_ids=extra_position_ids, attn_mask=extra_attn_mask)
print(logits)